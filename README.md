...
Estrellas fugaces animadas que cruzan la pantalla de forma continua.

Un conjunto de flores animadas, creadas únicamente con elementos HTML y animaciones CSS.

Hierba y hojas con movimientos suaves para dar realismo.

Un mensaje especial que aparece de forma suave mediante un efecto fade-in.

Animaciones avanzadas con transform, rotate, scale, blur, radial-gradient, linear-gradient y keyframes complejos.
...
Flores y hierba animadas

Dentro de la sección de flores, se organizan diversos elementos:

.flower → Cada flor independiente

.flower__leafs → Conjunto de pétalos circulares

.flower__white-circle → Centro de la flor (simulación de un girasol)

.flower__line → Tallo

.flower__line__leaf → Hojas laterales

.flower__light → Efecto de semillas iluminadas
...
<div class="special-text">Para mi Irene: ...</div>


Los colores de las flores editando las variables y gradientes.

La cantidad de estrellas fugaces duplicando o eliminando los elementos:

<div class="shooting-star"></div>


La escala del conjunto de flores cambiando:
